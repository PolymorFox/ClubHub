...
export default function Login() {
  ...
  return (
    ...
    <div className="relative w-full flex items-center justify-center font-sans overflow-hidden mt-[10vh]">
      {/* Login Card - More compact and shadcn-like */}
      <div className="relative w-full max-w-sm p-6 space-y-6 bg-white rounded-lg border border-zinc-200 shadow-gray-200 ">
        {/* Header section with icon and title - More compact */}
        <div className="text-center space-y-3">
          <div className="inline-flex p-2 bg-zinc-100 rounded-md ">
            <UserIcon />
          </div>
          <div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="flex h-9 w-full rounded-md border border-zinc-200 bg-white px-3 py-5 pr-10 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-zinc-500 dark:placeholder:text-zinc-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-300 disabled:cursor-not-allowed disabled:opacity-50"
              />
              <button
                type="button"
